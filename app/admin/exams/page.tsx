    ...
    <div className="p-8 space-y-8 min-h-screen bg-slate-50/50">
      ...
      {filteredExams.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="p-8 flex flex-col h-full">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8 pt-4 border-t border-slate-50">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-lg font-black text-slate-800">{exam.totalPoints} pts</p>
                        </div>
                    </div>
          ...
          <>
            {/* Table View (Desktop) */}
            <div className="hidden md:block bg-white rounded-[2rem] border border-slate-100 shadow-xl overflow-x-auto">
