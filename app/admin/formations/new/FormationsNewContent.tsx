...
export default function FormationsNewContent() {
          ...
          {success && (
            <Alert className="mb-6 border-emerald-200 bg-emerald-50">
              ...
              <AlertDescription className="text-emerald-700">
                Formation creee avec succes ! Redirection en cours...
              </AlertDescription>
            </Alert>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Decrivez la formation, ses objectifs, son public cible..."
                rows={4}
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Appuyez sur Entree pour ajouter une competence
              </p>
            </div>

            {form.name && (
              <div className="border-t pt-6">
                <h3 className="text-sm font-semibold text-slate-700 mb-3">Apercu</h3>
