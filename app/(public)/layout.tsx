...
export default function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Header */}
      <header className="w-full flex justify-between items-center px-6 py-4 max-w-4xl mx-auto relative sticky top-0 z-50 bg-gradient-to-br from-gray-50 to-gray-100 shadow-md">
        ...
        <nav className="hidden sm:flex gap-2 items-center">
          ...
          <Link href="/annuaire" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-semibold text-gray-800 hover:bg-gray-200 transition">
            Annuaire
          </Link>
        ...
        {open && (
          ...
          >
            ...
            <Link
              href="/annuaire"
              className="block px-6 py-4 text-gray-900 font-semibold hover:bg-gray-100 border-t"
              onClick={() => setOpen(false)}
              role="menuitem"
            >
              Annuaire
